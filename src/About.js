...
function About({}) {
    return (
        <div className="about-page">
            ...
            <p>这些“网址大全”书籍 - 经常被称为互联网的“黄页” - 给当时的中文互联网用户提供了按主题分类的中文网页URL列表。今天，这些书籍以及上面登载的网页URL给互联网历史研究者提供了研究世纪之交时中文用户使用互联网体验的材料。</p>
            ...
            <p>在网站主页上，您可以使用搜索框检索标题或者分类信息中带有指定关键词的网页，也可以用主页右侧的书籍标签过滤出仅在某本书中出现的网页。</p>
